...
a persistence unit "Eva56MorochoCarlosServerPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Eva56MorochoCarlosServer\pom.xml":
...
artifact ("Eva56MorochoCarlosServer.war") is already built. You can build
